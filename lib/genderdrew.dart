import 'package:bmi_calc_app/boygirl.dart';
...
class GenderDrew extends StatelessWidget {
  @override
            ...
            child: new Column(
              ...
              children: [
                ...
                new Container(
                  padding: EdgeInsets.only(left: 60, right: 60),
                  child: Text(
                    'This app was made from the motive to make people aware about their health.',
                    style: new TextStyle(
                      fontFamily: 'Apple',
                      fontSize: 22,
                    ),
